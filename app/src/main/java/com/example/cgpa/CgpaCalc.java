...
public class CgpaCalc extends AppCompatActivity {
    EditText a1,a2,a3,a4,a5,a6,a7,a8,b1,b2,b3,b4,b5,b6,b7,b8,c0;
    static float c1,c2,c3,c4,c5,c6,c7,c8,d1,d2,d3,d4,d5,d6,d7,d8,d9;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        c0=(EditText)findViewById(R.id.editText18);
    }
    public void f2(View abc)
    {
        ...
        d9 = Float.parseFloat(c0.getText().toString());
        float avg,perc;
        avg = ((c1*d1)+(c2*d2)+(c3*d3)+(c4*d4)+(c5*d5)+(c6*d6)+(c7*d7)+(c8*d8))/d9;
        perc = (float) (avg*(10-0.5));
        Intent ab = new Intent(this,CgpaRes.class);
        ab.putExtra("cgpa",avg);
